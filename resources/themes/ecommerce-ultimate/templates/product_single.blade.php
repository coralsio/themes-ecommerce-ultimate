    ...
    <div class="container padding-bottom-3x mt-5">
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                {!! CoralsForm::openForm(null,['url'=>url('cart/'.$product->hashed_id.'/add-to-cart'),'method'=>'POST','class'=> 'ajax-form','data-page_action'=>"updateCart"]) !!}
                @if(!$product->isSimple)
                    @foreach($product->activeSKU as $sku)
                        ...
                        @endif
                    @endforeach
                    @if(isset($lastLoop) && !$lastLoop)</div>@endif
            ...
            <div class="mb-2">
                <span
                    class="text-medium">@lang('corals-ecommerce-ultimate::labels.template.product_single.category')</span>
            ...
            @if($product->activeTags->count())
                <div class="padding-bottom-1x mb-2">
                    <span
                        class="text-medium">@lang('corals-ecommerce-ultimate::labels.template.product_single.tag')</span>

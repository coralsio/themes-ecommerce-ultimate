                ...
                <div class="padding-top-1x padding-bottom-1x">
                    ...
                    @auth
                        <a href="{{ url('e-commerce/orders/my') }}"
                           class="btn btn-success">@lang('corals-ecommerce-ultimate::labels.template.checkout_success.go_my_order')</a>
                    @else
                        <h5 class="text text-info">@lang('corals-ecommerce-ultimate::labels.template.checkout_success.order_guest_email_sent',['email'=>isset($order) && $order->billing ?$order->billing['billing_address']['email']:''])</h5>

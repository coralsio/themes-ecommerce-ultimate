...
<div class="offcanvas-wrapper">
    ...
    <div class="container-fluid mb-3  col-md-11">
        <div class="row">
            <div class="col-md-6">
            ...
            @if(!(isset($hide_sidebar) && $hide_sidebar))
                <div class="col-md-3">
                    ...
                    <aside class="user-info-wrapper">
                        ...
                        <div class="user-info">
                            <div class="user-avatar"><a class="edit-avatar" href="{{ url('profile#profile') }}"></a><img
                                        src="{{ user()->picture_thumb }}" alt="{{ user()->full_name }}"></div>
                            <div class="user-data">
                                <h4>{{ user()->full_name }}</h4><span>{{ user()->present('created_at') }}</span>
                            </div>
                        </div>
                    </aside>
                    <nav class="list-group list-group-root well">
                        <a class="list-group-item {{ \Request::is('dashboard')?'active':'' }}"
                           href="{{ url('dashboard') }}">
                            @lang('corals-ecommerce-ultimate::labels.partial.dashboard')
                        </a>
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">
                    <strong>@lang('corals-ecommerce-ultimate::labels.auth.change_image')</strong></h5>
            ...
            <div class="modal-body">
                ...
                <div class="actions my-3">
                        <span class="">
                            @lang('corals-ecommerce-ultimate::labels.auth.browse_files')
            ...
            <div class="modal-footer">
                <button type="submit" class="btn btn-primary m-r-10 m-l-10"
                        id="Save">@lang('corals-ecommerce-ultimate::labels.auth.save',['title'=>''])</button>
                <button type="button" class="btn btn-default"
                        data-dismiss="modal">@lang('corals-ecommerce-ultimate::labels.auth.close')</button>
            </div>
        </div>
    </div>
</div>
